...
class ScrollAwareFABBehavior : FloatingActionButton.Behavior() {
    ...
    private fun animateIn(floatingActionButton: FloatingActionButton) {
        ...
        ViewCompat.animate(floatingActionButton).scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setInterpolator(INTERPOLATOR)
                .setDuration(300).withLayer().setListener(object : ViewPropertyAnimatorListener {
    ...
    private fun animateOut(floatingActionButton: FloatingActionButton) {
        ViewCompat.animate(floatingActionButton).scaleX(0.0f).scaleY(0.0f).alpha(0.0f).setInterpolator(INTERPOLATOR)
                .setDuration(150).withLayer().setListener(object : ViewPropertyAnimatorListener {
                    override fun onAnimationStart(view: View) {
                        this@ScrollAwareFABBehavior.mIsAnimatingOut = true
                    }
